    ...
    <div className="max-w-6xl mx-auto px-6 py-4 text-[11px]">
      <div className="flex justify-between items-center mb-4 border-b pb-2 text-[11px]">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={handleImportClick} className="flex items-center gap-1 bg-white hover:bg-slate-50 px-3 py-1.5 rounded border border-slate-300 text-slate-600 font-bold transition-all text-[10px]"><Upload className="w-3.5 h-3.5" /> IMPORT</button>
          <button onClick={handleDownload} className="flex items-center gap-1 bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded border border-slate-300 text-slate-600 font-bold transition-all text-[10px]"><Download className="w-3.5 h-3.5" /> DOWNLOAD</button>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-8 space-y-4">
          ...
          <div className="bg-white border border-slate-200 rounded shadow-sm overflow-hidden font-bold">
            <div className="flex justify-between items-center p-2 bg-slate-50 cursor-pointer" onClick={() => toggleSection('inrush')}>
              <h2 className="font-bold flex items-center gap-1.5 text-slate-700 uppercase">
                ...
                <Activity className="w-3.5 h-3.5 text-orange-500" /> Inrush
              </h2>
              {openSections.inrush && <button onClick={e => { e.stopPropagation(); setConfig({...config, transformers: [...(config.transformers || []), {name: "TX-NEW", sn_kva: 0, u_kv: 0, ratio_iencl: 0, tau_ms: 0}]})}} className="text-[9px] font-bold bg-white text-orange-600 px-2 py-0.5 rounded border border-orange-200 hover:bg-orange-50">+ ADD TX</button>}
            </div>
            {openSections.inrush && (
          ...
          <div className="bg-white border border-slate-200 rounded shadow-sm overflow-hidden font-bold">
            <div className="flex justify-between items-center p-2 bg-slate-50 cursor-pointer" onClick={() => toggleSection('loadflow')}>
              <h2 className="font-bold flex items-center gap-1.5 text-slate-700 uppercase">
                ...
                <Zap className="w-3.5 h-3.5 text-yellow-500" /> Loadflow
              </h2>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded shadow-sm overflow-hidden font-bold">
            <div className="flex justify-between items-center p-2 bg-slate-50 cursor-pointer" onClick={() => toggleSection('protection')}>
              <h2 className="font-bold flex items-center gap-1.5 text-slate-700 uppercase">
                ...
                <ShieldCheck className="w-3.5 h-3.5 text-blue-600" /> Protection
              </h2>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded shadow-sm overflow-hidden font-bold">
            <div className="flex justify-between items-center p-2 bg-slate-50 cursor-pointer" onClick={() => toggleSection('coordination')}>
              <h2 className="font-bold flex items-center gap-1.5 text-slate-700 uppercase text-[10px]">
        ...
        <div className="col-span-12 lg:col-span-4">
          <div className="bg-slate-900 rounded border border-slate-800 p-3 h-full sticky top-4 shadow-xl">
             <p className="text-[9px] text-slate-500 font-bold uppercase mb-2 border-b border-slate-700 pb-1 italic text-left">Live configuration preview</p>
