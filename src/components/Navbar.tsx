...
import { Menu, X } from 'lucide-react'; // Import direct pour le menu burger
...
export default function Navbar({ user, onLogout }: NavbarProps) {
  ...
  const [showMobileMenu, setShowMobileMenu] = useState(false); // [NEW] State pour le menu mobile
